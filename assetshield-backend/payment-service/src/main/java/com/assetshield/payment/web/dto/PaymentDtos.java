package com.assetshield.payment.web.dto;
...
public final class PaymentDtos {
    ...
    /** One row of the payer's billing history. */
    public record PaymentSummary(String reference, String purpose, BigDecimal amount,
                                 String currency, String status, Instant createdAt) {
    }
}
