...
/**
 * Dev/offline-demo fallback (STORAGE_PROVIDER=local): writes under a compose
 * volume and serves downloads through short-lived tokens streamed by
 * {@code PublicFileController}. Keeps the system runnable without internet.
 */
