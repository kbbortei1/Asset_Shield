...
import com.assetshield.damage.security.EnvelopeResponses;
import com.assetshield.damage.security.InternalApiKeyFilter;
import com.assetshield.damage.security.JwtAuthenticationFilter;
import com.assetshield.damage.security.TokenService;
    ...
    public SecurityFilterChain apiChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // Token-gated downloads issued by the local storage provider
                        .requestMatchers("/api/v1/public/damage-files/**").permitAll()
                        // Share links: possession of the share token IS the authorization
                        .requestMatchers("/api/v1/dossiers/shared/**").permitAll()
