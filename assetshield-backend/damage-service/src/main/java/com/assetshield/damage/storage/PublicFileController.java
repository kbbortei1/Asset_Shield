 ...
 * possession of an unexpired token IS the authorization). Distinct path from
 * property-service's controller so the gateway can route per service.
 */
@RestController
@RequestMapping("/api/v1/public/damage-files")
